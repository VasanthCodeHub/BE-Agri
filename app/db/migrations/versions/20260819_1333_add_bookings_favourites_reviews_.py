...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["vehicle_id"],
            ["vehicles.id"],
            name=op.f("fk_favourites_vehicle_id_vehicles"),
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "rating BETWEEN 1 AND 5", name=op.f("ck_reviews_ck_reviews_rating_range")
        ),
        sa.ForeignKeyConstraint(
            ["reviewer_user_id"],
            ["users.id"],
            name=op.f("fk_reviews_reviewer_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["vehicle_id"],
            ["vehicles.id"],
            name=op.f("fk_reviews_vehicle_id_vehicles"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_reviews_reviewer_user_id"), "reviews", ["reviewer_user_id"], unique=False
    )
    op.create_index(
